...
import 'package:flutter_app/src/pages/map/google_maps_page.dart';

class AppRoute {
  static const homeRoute = "home";
  static const loginRoute = "login";
  static const managementRoute = "manangement";
  static const googleMapsRoute = "maps";
  ...
  final _route = <String, WidgetBuilder> {
    ...
    googleMapsRoute: (context) => GoogleMapPage()
  };
}